...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.use(VueRouter);
	var VueResource = __webpack_require__(7);
	Vue.use(VueResource);
	// 定义组件
	var Foo = Vue.extend({
	...
	router.map({
		...
		'/doday_work': {
			...
			subRoutes: {
				...
				"/all_patient": {
					name: "allPatient",
					component: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./views/allPatient.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
				}
			}
		}
	});
